const Privacy = () => (
  <main className="p-4 max-w-4xl mx-auto mb-40">
    ...
    <p className="mt-4">
      Your privacy is important to us. It is NotionFlow's policy to respect your privacy regarding any information we may
    ...
    <p className="mt-4">
      You can sign up with your Google account so your NotionFlow's account username will be prefilled with your name and
    ...
    <p className="mt-4">
      ...
      through
      NotionFlow and the services in terms of the applicable data protection laws, including the EU General Data
      Protection
      Regulation (GDPR).
    </p>
    <p className="mt-4">
